...
SECRET_KEY = 'w=0at6md2jrj$0u1k@w4qupj(a!3kmfc0j$%q*0rn$5*2wsmug'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('OPENSHIFT_POSTGRESQL_DB_NAME', 'recipe'),
        'USER': os.environ.get('OPENSHIFT_POSTGRESQL_DB_USERNAME', 'recipe'),
